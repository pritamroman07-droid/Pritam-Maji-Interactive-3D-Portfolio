 ...
 * Storage abstraction.
 *
 * If MONGODB_URI is set, all data lives in MongoDB Atlas.
 * Otherwise the app transparently falls back to a local JSON
...
function getMongoClient() {
  ...
  if (!mongoClientPromise) {
    mongoClientPromise = new MongoClient(uri, { serverSelectionTimeoutMS: 5000 }).connect();
  }
